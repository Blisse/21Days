...
using HappyBetter.Common;
using HappyBetter.ViewModels;
using Microsoft.Phone.Controls;
using Microsoft.Phone.Shell;
using HappyBetter.Resources;
...
namespace HappyBetter
{
    public partial class App : Application
    {
        ...
        {
            RootFrame.Background = new SolidColorBrush(Color.FromArgb(0xFF, 0x11, 0x11, 0x11));
        }
